...
import com.harsh.app.domain.Entry;
import com.harsh.app.repository.EntryRepository;
...
/**
 * REST controller for managing {@link com.harsh.app.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EntryResource {
    ...
    public ResponseEntity<?> getEntry(@PathVariable Long id) {
        ...
        if(entry.isPresent() && entry.get().getBlog().getUser()!=null && !entry.get().getBlog().getUser().getLogin().equals(SecurityUtils.getCurrentUserLogin().orElse(""))){
