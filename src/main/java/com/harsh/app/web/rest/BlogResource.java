...
import com.harsh.app.domain.Blog;
import com.harsh.app.repository.BlogRepository;
...
/**
 * REST controller for managing {@link com.harsh.app.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BlogResource {
    ...
    public ResponseEntity<?> getBlog(@PathVariable Long id) {
        ...
        if(blog.isPresent() && blog.get().getUser()!=null && !blog.get().getUser().getLogin().equals(SecurityUtils.getCurrentUserLogin().orElse(""))){
