...
describe('Blog e2e test', () => {
  ...
  it('should load Blogs', async () => {
    ...
    expect(await blogComponentsPage.getTitle()).to.eq('angularApp.blog.home.title');
  ...
  it('should load create Blog page', async () => {
    ...
    expect(await blogUpdatePage.getPageTitle()).to.eq('angularApp.blog.home.createOrEditLabel');
  ...
  it('should delete last Blog', async () => {
    ...
    expect(await blogDeleteDialog.getDialogTitle()).to.eq('angularApp.blog.delete.question');
